  ...
  return (
    <section className="bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-xs sm:text-sm text-gray-600 mb-8 leading-relaxed max-w-2xl mx-auto text-center">
        ...
        <div className="relative bg-gradient-to-r from-[#C8287E]/5 to-white rounded-lg shadow-md p-8 mb-10">
          ...
          <p className="text-xs sm:text-sm text-gray-600 mt-4 leading-relaxed max-w-xl mx-auto">
          ...
          <p className="text-xs sm:text-sm font-semibold text-color mt-4 leading-relaxed max-w-xl mx-auto">
        ...
        <div className="relative">
          <h3 className="text-lg sm:text-xl font-semibold text-color mb-6 text-center">
