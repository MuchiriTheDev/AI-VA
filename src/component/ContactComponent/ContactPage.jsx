  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Contact Us
          <span className="block text-xl sm:text-2xl md:text-3xl italic text-[#a62066] mt-2">
        ...
        {/* Subheadline */}
        <motion.p
          className="text-sm sm:text-base md:text-lg text-gray-600 mb-12 text-center leading-relaxed max-w-4xl mx-auto"
          variants={itemVariants}
        >
        ...
        <div className="space-y-12 max-w-4xl mx-auto">
          ...
          >
            ...
            <ul className="text-sm sm:text-base text-gray-600 leading-relaxed space-y-3 list-none text-center">
          ...
          >
            ...
            <ul className="text-sm sm:text-base text-gray-600 leading-relaxed space-y-3 list-disc list-inside text-center">
