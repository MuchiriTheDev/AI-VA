...
const ContactUs = () => {
 ...
 const data = {
 access_key: '8a447905-95b4-4bf7-a86c-2590c58e253c', // Use env variable in production
 name: formData.name,
 email: formData.email,
 businessName: formData.businessName || 'N/A',
 website: formData.website || 'N/A',
 location: formData.location === 'Other' ? formData.locationOther : formData.location || 'N/A',
 supportTypes: formData.supportTypes.join(', ') || 'N/A',
 otherSupport: formData.otherSupport || 'N/A',
 priority: formData.priority || 'N/A',
 startTime: formData.startTime || 'N/A',
 success: formData.success || 'N/A',
 additionalInfo: formData.additionalInfo || 'N/A',
 subject: 'New Contact Form Submission from AI Empowered VAs',
